        				...
        				<tbody>
        					...
        					<?php foreach ($subMenu as $sm) : ?>
        						<tr>
        							...
        							<td><i class="fas fa-check-square" <?= $sm['is_active']; ?>></i></td>
        							<td>
        								<a href="" data-toggle="modal" data-target="#editSubMenuModal" class="badge badge-success">Edit</a>
        ...
        <!-- Modal untuk edit -->
        <div class="modal" id="editSubMenuModal" tabindex="-1" role="dialog" aria-labelledby="editSubMenuModalLabel" aria-hidden="true">
        	<div class="modal-dialog">
        		<div class="modal-content">
        			<div class="modal-header">
