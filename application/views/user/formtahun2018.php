...
<div class="container-fluid">
	...
	<div class="card shadow mb-4">
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-primary">Upload File Tahunan 2018</h6>
		</div>
		<div class="card-body">
			<?= form_open_multipart('user/inputtahun2018');  ?>
	...
	<div class="card shadow mb-4">
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-primary">Data Tahunan Tahun 2018</h6>
		</div>
		<div class="card-body">
			<div class="row">
				<div class="col-lg">
					...
					<table class="table table-bordered" style="min-width: 100px">
						...
						<tbody>
							<tr>
								...
								<?php else : ?>
									<td><?= $dahun['skp']; ?> <br>
										<a href="<?= base_url('hapusdandownloadpokok/downloadskp2018') ?>" class="badge badge-info">Download</a>
										<a href="<?= base_url('hapusdandownloadtahunan/hapusskp2018') ?>" class="badge badge-danger">Delete</a>
									</td>
								<?php endif; ?>
								...
								<?php else : ?>
									<td><?= $dahun['pak']; ?> <br>
										<a href="<?= base_url('hapusdandownloadpokok/downloadpak2018') ?>" class="badge badge-info">Download</a>
										<a href="<?= base_url('hapusdandownloadtahunan/hapuspak2018') ?>" class="badge badge-danger">Delete</a>
									</td>
								<?php endif; ?>
							</tr>
						</tbody>
